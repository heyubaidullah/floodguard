 ...
 * ```
 */
export declare function serializeArtifact(artifact: Artifact): string;
/**
 ...
 * ```
 */
export declare function deserializeArtifact(data: string): Artifact;
/**
 ...
 * ```
 */
export declare function validateArtifact(artifact: Artifact): boolean;
