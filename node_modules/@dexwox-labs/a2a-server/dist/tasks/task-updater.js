 ...
 * ```
 */
class InvalidTaskStateError extends a2a_core_1.A2AError {
    /**
...
class TaskUpdater {
     ...
     * ```
     */
    transitionTask(taskId, newState) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentTask = yield this.taskManager.getTask(taskId);
            // Validate state transition
            if (!this.isValidTransition(currentTask.status, newState)) {
                throw new InvalidTaskStateError(`Invalid transition from ${currentTask.status} to ${newState}`);
            }
...
//# sourceMappingURL=task-updater.js.map